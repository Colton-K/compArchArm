...
hist_csv_file = 'dogs_cats_birds_model_case03_30epoch.csv'
...
###################################################################################################
model.save('dogs_cats_birds_model_case03_30epoch')

plot_model(model, to_file='dogs_cats_birds_model_case03.png', show_shapes=True, show_layer_names=True)
