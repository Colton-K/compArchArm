...
###################################################################################################
model.save('dogs_cats_birds_model_case03_100epoch')

plot_model(model, to_file='dogs_cats_birds_model_case03_100epoch.png', show_shapes=True, show_layer_names=True)
