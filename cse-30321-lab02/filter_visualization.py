...
#  model=load_model('dogs_cats_birds_model_case02_30epoch')
model=load_model('dogs_cats_birds_model_case03_30epoch')
...
###################################################################################################   
#  save_img('dogs_cats_birds_model_case01_XXepoch_%dx%d.png' % (n, n), stitched_filters)
#  save_img('dogs_cats_birds_model_case02_XXepoch_%dx%d.png' % (n, n), stitched_filters)
save_img('dogs_cats_birds_model_case03_XXepoch_%dx%d.png' % (n, n), stitched_filters)
print('saved')
